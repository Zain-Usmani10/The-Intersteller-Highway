...
# ============ STARTS AT 800x600, PRESS F11 TO TOGGLE FULLSCREEN ============
...
#planets for the dropdowns in screen2
planet_options = [
...
#departure and destination dropdown box
...
while running:
    ...
    if current_screen == "menu":
        ...
        if logo_img:
            logo_scaled = transform.smoothscale(logo_img, (820, 50))
            logo_rect = logo_scaled.get_rect(center=(WIDTH // 2, 160))
